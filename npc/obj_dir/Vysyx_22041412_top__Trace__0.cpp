...
void Vysyx_22041412_top___024root__trace_chg_sub_0(Vysyx_22041412_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+541,(vlSelf->ysyx_22041412_top__DOT__axi4__DOT__axi_ar_valid));
        bufp->chgCData(oldp+542,(vlSelf->ysyx_22041412_top__DOT__axi_Arbiter__DOT__rd_switch),3);
        bufp->chgCData(oldp+543,(vlSelf->ysyx_22041412_top__DOT__axi_Arbiter__DOT__rd_state),2);
        bufp->chgCData(oldp+544,(vlSelf->ysyx_22041412_top__DOT__axi_Arbiter__DOT__wr_switch),3);
    ...
    bufp->chgBit(oldp+562,(vlSelf->rst));
    bufp->chgQData(oldp+563,(vlSelf->pip_pc),64);
    bufp->chgQData(oldp+565,(vlSelf->pip_dnpc),64);
    bufp->chgQData(oldp+567,(vlSelf->pip_mem_pc),64);
    bufp->chgBit(oldp+569,(vlSelf->Ebreak));
    bufp->chgQData(oldp+570,(vlSelf->Icache_L1_miss),64);
    bufp->chgQData(oldp+572,(vlSelf->Icache_L1_hit),64);
    bufp->chgQData(oldp+574,(vlSelf->Dcache_L1_miss),64);
    bufp->chgQData(oldp+576,(vlSelf->Dcache_L1_hit),64);
    bufp->chgBit(oldp+578,(vlSelf->io_master_awready));
    bufp->chgBit(oldp+579,(vlSelf->io_master_awvalid));
    bufp->chgIData(oldp+580,(vlSelf->io_master_awaddr),32);
    bufp->chgCData(oldp+581,(vlSelf->io_master_awprot),3);
    bufp->chgCData(oldp+582,(vlSelf->io_master_awid),4);
    bufp->chgBit(oldp+583,(vlSelf->io_master_awuser));
    bufp->chgCData(oldp+584,(vlSelf->io_master_awlen),8);
    bufp->chgCData(oldp+585,(vlSelf->io_master_awsize),3);
    bufp->chgCData(oldp+586,(vlSelf->io_master_awburst),2);
    bufp->chgBit(oldp+587,(vlSelf->io_master_awlock));
    bufp->chgCData(oldp+588,(vlSelf->io_master_awcache),4);
    bufp->chgCData(oldp+589,(vlSelf->io_master_awqos),4);
    bufp->chgCData(oldp+590,(vlSelf->io_master_awregion),4);
    bufp->chgBit(oldp+591,(vlSelf->io_master_wready));
    bufp->chgBit(oldp+592,(vlSelf->io_master_wvalid));
    bufp->chgQData(oldp+593,(vlSelf->io_master_wdata),64);
    bufp->chgCData(oldp+595,(vlSelf->io_master_wstrb),8);
    bufp->chgBit(oldp+596,(vlSelf->io_master_wlast));
    bufp->chgBit(oldp+597,(vlSelf->io_master_wuser));
    bufp->chgBit(oldp+598,(vlSelf->io_master_bready));
    bufp->chgBit(oldp+599,(vlSelf->io_master_bvalid));
    bufp->chgCData(oldp+600,(vlSelf->io_master_bresp),2);
    bufp->chgCData(oldp+601,(vlSelf->io_master_bid),4);
    bufp->chgBit(oldp+602,(vlSelf->io_master_buser));
    bufp->chgBit(oldp+603,(vlSelf->io_master_arready));
    bufp->chgBit(oldp+604,(vlSelf->io_master_arvalid));
    bufp->chgIData(oldp+605,(vlSelf->io_master_araddr),32);
    bufp->chgCData(oldp+606,(vlSelf->io_master_arprot),3);
    bufp->chgCData(oldp+607,(vlSelf->io_master_arid),4);
    bufp->chgBit(oldp+608,(vlSelf->io_master_aruser));
    bufp->chgCData(oldp+609,(vlSelf->io_master_arlen),8);
    bufp->chgCData(oldp+610,(vlSelf->io_master_arsize),3);
    bufp->chgCData(oldp+611,(vlSelf->io_master_arburst),2);
    bufp->chgBit(oldp+612,(vlSelf->io_master_arlock));
    bufp->chgCData(oldp+613,(vlSelf->io_master_arcache),4);
    bufp->chgCData(oldp+614,(vlSelf->io_master_arqos),4);
    bufp->chgCData(oldp+615,(vlSelf->io_master_arregion),4);
    bufp->chgBit(oldp+616,(vlSelf->io_master_rready));
    bufp->chgBit(oldp+617,(vlSelf->io_master_rvalid));
    bufp->chgCData(oldp+618,(vlSelf->io_master_rresp),2);
    bufp->chgQData(oldp+619,(vlSelf->io_master_rdata),64);
    bufp->chgBit(oldp+621,(vlSelf->io_master_rlast));
    bufp->chgCData(oldp+622,(vlSelf->io_master_rid),4);
    bufp->chgBit(oldp+623,(vlSelf->io_master_ruser));
    bufp->chgBit(oldp+624,(vlSelf->io_slave_awready));
    bufp->chgBit(oldp+625,(vlSelf->io_slave_awvalid));
    bufp->chgIData(oldp+626,(vlSelf->io_slave_awaddr),32);
    bufp->chgCData(oldp+627,(vlSelf->io_slave_awid),4);
    bufp->chgCData(oldp+628,(vlSelf->io_slave_awlen),8);
    bufp->chgCData(oldp+629,(vlSelf->io_slave_awsize),3);
    bufp->chgCData(oldp+630,(vlSelf->io_slave_awburst),2);
    bufp->chgBit(oldp+631,(vlSelf->io_slave_wready));
    bufp->chgBit(oldp+632,(vlSelf->io_slave_wvalid));
    bufp->chgQData(oldp+633,(vlSelf->io_slave_wdata),64);
    bufp->chgCData(oldp+635,(vlSelf->io_slave_wstrb),8);
    bufp->chgBit(oldp+636,(vlSelf->io_slave_wlast));
    bufp->chgBit(oldp+637,(vlSelf->io_slave_bready));
    bufp->chgBit(oldp+638,(vlSelf->io_slave_bvalid));
    bufp->chgCData(oldp+639,(vlSelf->io_slave_bresp),2);
    bufp->chgCData(oldp+640,(vlSelf->io_slave_bid),4);
    bufp->chgBit(oldp+641,(vlSelf->io_slave_arready));
    bufp->chgBit(oldp+642,(vlSelf->io_slave_arvalid));
    bufp->chgIData(oldp+643,(vlSelf->io_slave_araddr),32);
    bufp->chgCData(oldp+644,(vlSelf->io_slave_arid),4);
    bufp->chgCData(oldp+645,(vlSelf->io_slave_arlen),8);
    bufp->chgCData(oldp+646,(vlSelf->io_slave_arsize),3);
    bufp->chgCData(oldp+647,(vlSelf->io_slave_arburst),2);
    bufp->chgBit(oldp+648,(vlSelf->io_slave_rready));
    bufp->chgBit(oldp+649,(vlSelf->io_slave_rvalid));
    bufp->chgCData(oldp+650,(vlSelf->io_slave_rresp),2);
    bufp->chgQData(oldp+651,(vlSelf->io_slave_rdata),64);
    bufp->chgBit(oldp+653,(vlSelf->io_slave_rlast));
    bufp->chgCData(oldp+654,(vlSelf->io_slave_rid),4);
    bufp->chgCData(oldp+655,(((IData)(vlSelf->rst) ? 0U
                                   ...
                                   : ((2U & (IData)(vlSelf->ysyx_22041412_top__DOT__Icache_L1__DOT__state))
                                       ...
                                       : ((1U & (IData)(vlSelf->ysyx_22041412_top__DOT__Icache_L1__DOT__state))
                                           ...
                                           : ((IData)(vlSelf->ysyx_22041412_top__DOT__if_ar_valid)
                                               ? 1U
                                               : 0U)))))),3);
    bufp->chgCData(oldp+656,(vlSelf->ysyx_22041412_top__DOT__axi_Arbiter__DOT__rd_next_switch),3);
    bufp->chgCData(oldp+657,(((IData)(vlSelf->rst) ? 0U
